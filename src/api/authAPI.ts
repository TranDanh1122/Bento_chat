...
export const AuthAPI = {
    ...
    updateUser: (data: Pick<User, "avatar" | "cover" | "lastName" | "password" | "bio" | "websiteUrl" | "salt" | "role" | "status">, id: string, token: string) => api.patch(`users/${id}`, data, { headers: { Authorization: `Bearer ${token}` } }),
